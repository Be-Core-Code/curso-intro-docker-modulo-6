...
```bash
> docker run --rm -p "8006:8006" becorecode/curso-intro-docker-modulo-6:latest
```

Una vez levantado el contenedor, accede con un navegador web a `http://localhost:8006`
...
* Para imprimirlas:
  * Accede a la URL `http://localhost:8006/?print-pdf`
  * Imprime la página 
  * Si deseas añadir las notas del presentador utiliza la URL  `http://localhost:8006/?print-pdf&showNotes=true`
